...
enum LocalizedStringKeys {
    ...
    static let kServerError = "kServerError"
    static let kManyRequestsError = "kManyRequestsError"
    static let kTimeoutError = "kTimeoutError"
    static let kAuthError = "kAuthError"
